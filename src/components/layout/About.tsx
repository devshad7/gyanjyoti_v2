                ...
                <div className="p-12 flex flex-col justify-center">
                  ...
                  <div className="relative mb-8">
                    ...
                    <blockquote className="text-gray-700 text-lg md:text-xl leading-relaxed italic pl-8 font-body">
                      Our mission to transform the nation through education is the result of our two decades of experience in higher education. This globally proven platform, designed in Nepal and led by the best minds from Singapore and Cambridge, is our guiding light to a brighter future.
                    </blockquote>
                  </div>
